...
weathercondition = "fair" % mild, fair, harsh or extreme
...
for it = 1:N
    ...
    if pt < nP
        ...
        target = P(1:2,pt);
        next = P(1:2,pt+1);
        targetdist = norm(target-pos);
        nextdist = norm(next-pos);
...
%%
clear z1 z2
clear u v r pos psi tau
clear target targetdist next nextdist
...
save("Results/Figure8-"+weathercondition+".mat",'Efinal');
